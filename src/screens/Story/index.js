		...
		return (
			<div className="my-story">
				...
				<div className="story-information">
					<p>
						<b>Hola, I'm Matty!</b> I have a ginger kitty named Blue, I love
						golf, I live in Burlington, Vermont, I could read about sacred
						geometry for hours, Alan Watts is cool, I have been programming for
						four months and this is my first portfolio page.
					</p>
					<p>
						<strong>
						...
						with this journey so far is mind boggling but I am enjoying the
						process. If you're looking for someone with a lot of grit and
						eagerness to learn don't hesitate to get in touch. Thanks for
						visiting my page!
					</p>
				</div>
				...
				<div className="pagination">
					...
					>
						<p className="pagination-text">{'skills'}</p>
					</i>
				</div>
			</div>
		);
