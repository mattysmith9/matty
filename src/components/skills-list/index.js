      ...
      <div className="skill-content">
        ...
        <div className="skill-object">
          <div className="skill-title">
            ...
            <div className="skill-description">
              <span>
                Experience with Node, Express, Firebase, MongoDB, AWS, Heroku
                and source control using Git and Github. I am currently working
                on extending my knowledge further as I have found the back-end
